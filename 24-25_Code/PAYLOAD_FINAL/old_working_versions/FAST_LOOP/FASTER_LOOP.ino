...
void playMorse(std::string message);
...
void loop() {
  ...
  // playMorse("KQ4FYU");
  // playMorse("we landed radio works");
  // playMorse("KQ4FYU");
  // digitalWrite(PTTPIN, HIGH);
  onboardLed.show();
}  // End loop()
