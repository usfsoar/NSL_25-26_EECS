...
void loop() {
  if (rf96w.available()) {
    ...
    if (rf96w.recv(buf, &len)) {
      ...
      switch (buf[0]) {
        case '0':
          sd.appendFile(IMU_FILEPATH, (char*)buf + ID_OFFSET);
          sd.appendFile(IMU_FILEPATH, "\n");
          break;
        case '1':
          sd.appendFile(ALTIMETER_FILEPATH, (char*)buf + ID_OFFSET);
          sd.appendFile(ALTIMETER_FILEPATH, "\n");
          break;
        case '2':
          sd.appendFile(GPS_FILEPATH, (char*)buf + ID_OFFSET);
          sd.appendFile(GPS_FILEPATH, "\n");
          break;
        case '3':
          sd.appendFile(KALMAN_FILEPATH, (char*)buf + ID_OFFSET);
          sd.appendFile(KALMAN_FILEPATH, "\n");
          break;
        default:
          Serial.println("Invalid Identifier, Data Not Written");
          break;
      }
